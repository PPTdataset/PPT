...
def validate_v2(pre_path, val_path, ROOT, opt=None):
    #pre_path 训练结果
    #val 人工
    # 训练结果pre = ..\temp_data\results_validation\part3_v10_24e1t10r4_eps1_plus40\sigmoid_thr=0.500000
    # 人工标注val = '%s/val_data/part3/' % ROOT
    ...
    fn_dict = []
    # save_to_txt(pre_path, "***********miou***********", 'w')
    print(len(os.listdir(val_path)),len(os.listdir(val_json_path)),len(os.listdir(pre_path)))
