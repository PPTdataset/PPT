...
class Options():
    ...
    def __init__(self):
        ...
        ##
        # Base
        self.parser.add_argument('--dataset', default='PPT', help='folder | cifar10 | mnist ')
        ...
        self.parser.add_argument('--metric', type=str, default='auc', help='Evaluation metric.')
        ...
        self.parser.add_argument('--w_adv', type=float, default=5, help='Adversarial loss weight')
        self.parser.add_argument('--w_con', type=float, default=50, help='Reconstruction loss weight')
        self.parser.add_argument('--w_enc', type=float, default=5, help='Encoder loss weight.')
        self.isTrain = True
        self.opt = None
