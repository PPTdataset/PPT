...
def load_data(config):
    ...
    if config['dataset_name'] in ['cifar10']:
    ...
    elif config['dataset_name'] in ['PPT']:
        data_path = 'Dataset/PPT/' + normal_class + '/train'
        img_size = 128
        ...
        test_data_path = 'Dataset/PPT/' + normal_class + '/test'
        test_set = ImageFolder(root=test_data_path, transform=orig_transform)
...
def load_localization_data(config):
    ...
    ground_data_path = 'Dataset/PPT/' + normal_class + '/ground_truth'
